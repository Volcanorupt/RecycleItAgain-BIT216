...
$points=$_POST['points'];
$sql="INSERT INTO material(name,description,points) VALUES(:name,:description,:points)";
							...
							<div class="col-md-6">
								<section class="panel">
									<header class="panel-heading">
										<h2 class="panel-title">Add Materials</h2>
									</header>
									<div class="panel-body">
										...
										<?php if($error){?><div class="errorWrap"><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="number" step="1" pattern="\d+" name="points" class="form-control" id="inputRounded" required="">
												</div>
											</div>
											<div class="form-group">
